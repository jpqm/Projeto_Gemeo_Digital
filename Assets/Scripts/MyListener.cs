    ...
    void OnGUI()
    {
        ...
        for (int i = 0; i < joints.Length; i++)
        {
            ...
            if (manualMode)
            {
                ...
                // 1. Slider (largura reduzida para dar espaço à caixa)
                float sliderVal = GUI.HorizontalSlider(new Rect(20, yPos + 22, 200, 20), commandedAngles[i], -200f, 200f);
                ...
                // Se digitou na caixa, tenta converter para float e atualiza a junta
                if (textVal != angleInputs[i])
                {
                    ...
                    {
                        commandedAngles[i] = Mathf.Clamp(parsedVal, -200f, 200f);
                    }
                }
            }
            else
            {
                ...
                GUI.HorizontalSlider(new Rect(20, yPos + 22, 270, 20), displayValue, -200f, 200f);
            }
        }
